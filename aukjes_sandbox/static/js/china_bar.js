...
function get_data() {d3.json(url), function(response) {
...
for (var key in bar_values){
    y_values.push(bar_values[key])
}
...
// function buildCharts() {
    ...
    // var bar_dates = result.date;
    // var bar_confirmed = result.confirmed;
