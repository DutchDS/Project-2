...
//     console.log("in the d3.json part")
//     console.log(response);
//     create_chart(response)
// })}

// d3.json("/api/bar_china/file.json").then(
//   function(d){
//     console.log(d);
//     document.getElementById("#facts").innerHTML = d;
//   })
...
bar_dates = bar_data.date;
bar_confirmed = bar_data.confirmed;
bar_cured = bar_data.cured;
bar_dead = bar_data.dead;
